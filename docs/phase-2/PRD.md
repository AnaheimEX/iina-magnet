...
> 关键决策见 [ADR-0005（多源元数据）](../adr/0005-multi-source-metadata.md) 与 [ADR-0006（Anitomy 桥接）](../adr/0006-anitomy-bridge.md)。
...
详见 [ADR-0006](../adr/0006-anitomy-bridge.md)。`AnitomyBridge` 暴露最小 Obj-C 接口：
